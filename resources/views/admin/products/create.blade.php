...
<body class="bg-gray-100 min-h-screen py-8 px-4">
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Create New Product</h1>
            ...
            <form action="{{route('product.store')}}" method='POST' class="space-y-6" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input 
                        ...
                        required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"
                        placeholder="e.g., 2500,6000"
                        value="{{old('price')}}"
                    >
                    <p class="mt-1 text-sm text-gray-500">Enter a clear, price for the product</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Select the category for this product</p>
                </div>
